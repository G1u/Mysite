<?php
	...
	if (!$_SESSION['login']) {
		...
		header("Location: ".$dirname."../login.php?redirect=COA V2.0 Technical\Technical documentation\Introduction\index.php");
	}
?>
...
<nav class="md-tabs md-tabs--active" data-md-component="tabs">
  ...
  <li class="md-nav__item">
    <a href="../../Product/Introduction/" title="Introduction" class="md-nav__link">
      Introduction
    </a>
  </li>
...
<footer class="md-footer">
    ...
    <div class="md-footer-nav">
      <nav class="md-footer-nav__inner md-grid">
          ...
          <a href="../../Product/Introduction/" title="Introduction" class="md-flex md-footer-nav__link md-footer-nav__link--prev" rel="prev">
            <div class="md-flex__cell md-flex__cell--shrink">
          ...
          <a href="../../Technical reference/Introduction/" title="Introduction" class="md-flex md-footer-nav__link md-footer-nav__link--next" rel="next">
            <div class="md-flex__cell md-flex__cell--stretch md-footer-nav__title">
              <span class="md-flex__ellipsis">
                <span class="md-footer-nav__direction">
                  Next
