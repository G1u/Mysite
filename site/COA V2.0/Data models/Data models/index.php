<?php
	...
	if (!$_SESSION['login']) {
		...
		header("Location: ".$dirname."../login.php?redirect=COA V2.0\Data models\Data models\index.php");
	}
?>
...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="generator" content="mkdocs-1.0.4, mkdocs-material-4.6.3">
        ...
        <title>Data models - COA Documentation</title>
...
<nav class="md-tabs md-tabs--active" data-md-component="tabs">
  ...
  <li class="md-nav__item md-nav__item--active">
    ...
    <a href="./" title="Data models" class="md-nav__link md-nav__link--active">
      Data models
    </a>
...
<footer class="md-footer">
    ...
    <div class="md-footer-nav">
      <nav class="md-footer-nav__inner md-grid">
          ...
          <a href="../../Dimensions/Dimensions/" title="Dimensions" class="md-flex md-footer-nav__link md-footer-nav__link--next" rel="next">
            <div class="md-flex__cell md-flex__cell--stretch md-footer-nav__title">
              <span class="md-flex__ellipsis">
                <span class="md-footer-nav__direction">
                  Next
